  ...
  return (
    <header className="flex h-14 items-center gap-2 sm:gap-4 border-b border-border px-3 sm:px-6">
      ...
      <Link href="/dashboard" className="flex items-center gap-2 shrink-0">
        ...
        <span className="hidden sm:inline text-lg font-semibold">DevCache</span>
      </Link>
      ...
      <div className="flex items-center gap-1 sm:gap-2 shrink-0">
        ...
        <DropdownMenu>
          <DropdownMenuTrigger asChild>
            <Button size="icon" className="sm:hidden" aria-label="Create new item or collection" title="Create new item or collection">
