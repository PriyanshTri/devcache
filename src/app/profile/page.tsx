...
export default async function ProfilePage() {
  ...
  // and reuse getItemTypesWithCounts data instead of performing separate groupBy queries
  const [
    totalItems,
    totalCollections,
    itemTypesWithCounts,
  ...
  // Derive breakdown from the shared itemTypesWithCounts function instead of separate query
