...
export default async function ProfilePage() {
  ...
  // Performance Optimization: Batched independent database queries into a single Promise.all
  // to avoid sequential execution waterfalls and reduce overall query latency.
  // Also removed redundant queries for item counts and types, reusing getItemTypesWithCounts.
  const [
    totalItems,
    totalCollections,
    itemTypesWithCounts,
