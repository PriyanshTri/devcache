...
DevCache uses 7 system-defined item types to categorize developer resources. Each type has a specific purpose, icon, color, and content storage method. All system types are immutable (`isSystem: true`) and shared across all users.
