...
export default async function ProfilePage() {
  ...
  // Performance optimization: Batch queries using Promise.all to avoid sequential execution
  // Re-use `getItemTypesWithCounts` for `itemTypeBreakdown` instead of performing redundant grouping/querying
  const [
    totalItems,
    totalCollections,
    itemTypesWithCounts,
